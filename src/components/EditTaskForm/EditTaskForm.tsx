...
const EditTaskForm: React.FC<EditTaskFormProps> = ({ id, task }) => {
    ...
    const SubmitButton = () => {
        return (
            <button type="submit" className="mt-8 py-2 w-full bg-gray-800 text-white rounded-md hover:bg-gray-700 font-semibold disabled:bg-gray-400" disabled={isPending}>
                Update
            </button>
        )
    }
